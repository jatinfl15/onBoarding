...
open class OnboardingContentViewItem: UIView {
    ...
    init(titlePadding: CGFloat, descriptionPadding: CGFloat, index :Int) {
        super.init(frame: .zero)
        commonInit(titlePadding: titlePadding, descriptionPadding: descriptionPadding, index: index) // Jatins's Change
    }
...
extension OnboardingContentViewItem {
    ...
    class func itemOnView(_ view: UIView, titlePadding: CGFloat, descriptionPadding: CGFloat, index: Int) -> OnboardingContentViewItem { // Jatins's Change
        let item = Init(OnboardingContentViewItem(titlePadding: titlePadding, descriptionPadding: descriptionPadding, index: index)) { // Jatins's Change
...
private extension OnboardingContentViewItem {
    ...
    func commonInit(titlePadding: CGFloat, descriptionPadding: CGFloat, index: Int) { // Jatins's Change
        ...
        imageView.tag = index // Jatins's Change
